...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
            ...
            // Expect the todo not to be completed
            expect(model.read).toHaveBeenCalledWith({completed:false}, jasmine.any(Function));
            
            // Expect the same entry to have been shown
			expect(view.render).toHaveBeenCalledWith('showEntries', [todo]);
		});
		...
		it('should show completed entries', function () {
            ...
            // Expect the todo to be completed   
	...
	it('should highlight "Active" filter when switching to active view', function () {
        ...
        // Expect to be the actives one only
	...
	describe('toggle all', function () {
		beforeEach(function(){
            // Sets up todos
            var todos = [{id:1, title: 'todo 1', completed: false}, {id:2, title: 'todo 2', completed: false}];
            setUpModel(todos);
        ...
        it('should toggle all todos to completed', function () {
            ...
            // Expect them to have toggled in model
		...
		it('should update the view', function () {
            ...
            // Expect them to have toggled in view
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
            ...
            // Expect it to have been removed
